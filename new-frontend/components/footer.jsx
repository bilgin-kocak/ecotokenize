        ...
        <div className="container">
          <div className="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
            <div className="col-span-3 md:col-span-4">
              ...
              <Link href="#" className="mb-6 inline-block">
                <p>
                  <span className="text-jacarta-700 font-bold font-display mb-6 text-center text-5xl dark:text-white md:text-left lg:text-4xl xl:text-5xl">
                    Amarketpalace
                  </span>
                </p>
              </Link>
              ...
              <p className="dark:text-jacarta-300 mb-12">
                Create, sell and collect game digital assets. Powered by Areon
                Network.
              </p>
          ...
          <div className="flex flex-col items-center justify-between space-y-2 py-8 sm:flex-row sm:space-y-0">
            <span className="dark:text-jacarta-400 text-sm">
              <span>
                © {new Date().getFullYear()} Areon Fully Onchain NFT Marketplace
              </span>
            </span>
